...
import {Select, Container, HStack, Heading, Center, Box} from "@chakra-ui/react"
...
var misoptions = {
    ...
    <div>
        ...
        <Container maxW="md">
            ...
            <HStack>
            <span>DESDE:</span>
            <Select maxW="100" value={desde} onChange={(e)=>setDesde(e.target.value)}>
                { 
            ...
            <Select  maxW="100" value = {hasta} onChange={(e)=>setHasta(e.target.value)}>
                ...
                { 
                 !estadistica ? (<LoadingSpinner></LoadingSpinner>): 
