...
function EditEstab() {
  ...
  const { mutate, isLoading } = useMutation<Establecimiento, ApiError, FormState>({
        ...
        <Container centerContent gap="25px">
          <VStack spacing="4">
            ...
            <FormControl
              ...
              onChange={handleChange}
            >
              <Input name="correo" type="email" placeholder="abc@ejemplo.com" value={state.correo} />
            ...
            <FormControl
              ...
              onChange={handleChange}
            >
              <Input name="direccion" placeholder="Dirección" value={state.direccion}/>
            ...
            <HStack>
              <FormControl
                ...
                onChange={handleChange}
              >
                <Input name="localidad" placeholder="Localidad" value={state.localidad} />
              ...
              <FormControl
                ...
                onChange={handleChange}
              >
                <Input name="provincia" placeholder="Provincia" value={state.provincia} />
            ...
            <FormControl
              ...
              onChange={handleChange}
            >
              <Input name="telefono" placeholder="Teléfono" type="tel" value={state.telefono}/>
