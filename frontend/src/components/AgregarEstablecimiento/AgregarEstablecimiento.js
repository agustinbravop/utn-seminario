    ...
    <Container fluid="md" className="agregarestablecimiento">
      ...
      <Row className="mb-3">
        <Form.Group as={Col} controlId="formGridNombre">
          ...
          <Form.Control type="nombre" placeholder="Ingrese el nombre del establecimiento" />
        </Form.Group>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} controlId="formGridLocalidad">
          ...
          <Form.Control type="localidad" placeholder="Ingrese localidad" />
        </Form.Group>
      ...
      {/* Fin campos dobles */}
      <Form.Group as={Col}>
        <Form.Label className="text-center" style={{width: "100%"}}><h3>Horarios de Atención</h3></Form.Label> <br />
        <Form.Label className="text-center" style={{width: "100%"}}><h7>En qué rangos está abierto el establecimiento</h7></Form.Label>
      </Form.Group>

      <Row className="mb-3">        
      <Form.Group as={Col} controlId="formGridLunes">
          <Form.Label className="text-center" style={{width: "100%"}}>Lunes</Form.Label>
        ...
        <Form.Group as={Col} controlId="formGridMartes">
          <Form.Label className="text-center" style={{width: "100%"}}>Martes</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
        ...
        <Form.Group as={Col} controlId="formGridMiércoles">
          <Form.Label className="text-center" style={{width: "100%"}}>Miércoles</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
        ...
        <Form.Group as={Col} controlId="formGridJueves">
          <Form.Label className="text-center" style={{width: "100%"}}>Jueves</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
        ...
        <Form.Group as={Col} controlId="formGridViernes">
          <Form.Label className="text-center" style={{width: "100%"}}>Viernes</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
        ...
        <Form.Group as={Col} controlId="formGridSábado">
          <Form.Label className="text-center" style={{width: "100%"}}>Sábado</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
        ...
        <Form.Group as={Col} controlId="formGridDomingo">
          <Form.Label className="text-center" style={{width: "100%"}}>Domingo</Form.Label>
          <Form.Select defaultValue="Choose...">
            <option></option>
            <option>...</option>
          </Form.Select>
