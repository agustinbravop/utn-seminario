...
*/
-- DropForeignKey
ALTER TABLE "public"."administrador" DROP CONSTRAINT "administrador_idSuscripcion_fkey";

-- DropForeignKey
ALTER TABLE "public"."administrador" DROP CONSTRAINT "administrador_idTarjeta_fkey";
...
CREATE TABLE "suscripcion" (
    ...
    "nombre" VARCHAR NOT NULL,
    "limitEstablecimiento" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "administrador_idTarjeta_key" ON "administrador"("idTarjeta");

-- AddForeignKey
ALTER TABLE "administrador" ADD CONSTRAINT "administrador_idTarjeta_fkey" FOREIGN KEY ("idTarjeta") REFERENCES "tarjeta"("idTarjeta") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "administrador" ADD CONSTRAINT "administrador_idSuscripcion_fkey" FOREIGN KEY ("idSuscripcion") REFERENCES "suscripcion"("idSuscripcion") ON DELETE NO ACTION ON UPDATE NO ACTION;
