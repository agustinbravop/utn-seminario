...
export class EstablecimientoHandler {
  ...
  crearEstablecimiento(): RequestHandler {
    return async (req, res) => {
     ...
     if (idSuscripcion===1 && cantidad<1 || idSuscripcion===2 && cantidad<3 || idSuscripcion===3 && cantidad<15) { 
      ...
      console.log("La suscripcion asignada no le permite cargar mas establecimientos")
